	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				options: [
					{ name: 'Attachment', value: 'attachment', action: 'Work with attachments' },
					{ name: 'Attachments in a Transaction', value: 'attachmentsInATransaction', action: 'Work with transaction attachments' },
					{ name: 'Beneficiary', value: 'beneficiaries', action: 'Work with beneficiaries' },
					{ name: 'Card', value: 'cards', action: 'Work with cards' },
					{ name: 'Client', value: 'clients', action: 'Work with clients' },
					{ name: 'Client Invoice', value: 'clientsInvoices', action: 'Work with client invoices' },
					{ name: 'Credit Note', value: 'creditNotes', action: 'Work with credit notes' },
					{ name: 'External Transfer', value: 'externalTransfers', action: 'Work with external transfers' },
					{ name: 'Insurance Contract', value: 'insuranceContracts', action: 'Work with insurance contracts' },
					{ name: 'Internal Transaction', value: 'internalTransactions', action: 'Work with internal transactions' },
					{ name: 'Label', value: 'labels', action: 'Work with labels' },
					{ name: 'Membership', value: 'memberships', action: 'Work with memberships' },
					{ name: 'Organization', value: 'organizations', action: 'Work with organizations' },
					{ name: 'Request', value: 'requests', action: 'Work with requests' },
					{ name: 'Statement', value: 'statements', action: 'Work with statements' },
					{ name: 'Supplier Invoice', value: 'supplierInvoices', action: 'Work with supplier invoices' },
					{ name: 'Team', value: 'teams', action: 'Work with teams' },
					{ name: 'Transaction', value: 'transactions', action: 'Work with transactions' },
				],
