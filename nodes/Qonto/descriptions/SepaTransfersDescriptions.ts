...
export const sepaTransfersOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			{ name: 'Download SEPA Transfer Proof', value: 'downloadSepaTransferProof', action: 'Download proof of a SEPA transfer' },
			{ name: 'List SEPA Bulk Transfers', value: 'listSepaBulkTransfers', action: 'List SEPA bulk transfers' },
			{ name: 'Get SEPA Bulk Transfer', value: 'showSepaBulkTransfer', action: 'Get a SEPA bulk transfer' },
			{ name: 'Create SEPA Bulk Transfer', value: 'createSepaBulkTransfer', action: 'Create a SEPA bulk transfer' },
			{ name: 'List SEPA Recurring Transfers', value: 'listSepaRecurringTransfers', action: 'List SEPA recurring transfers' },
			{ name: 'Get SEPA Recurring Transfer', value: 'showSepaRecurringTransfer', action: 'Get a SEPA recurring transfer' },
			{ name: 'Create SEPA Recurring Transfer', value: 'createSepaRecurringTransfer', action: 'Create a SEPA recurring transfer' },
			{ name: 'Cancel SEPA Recurring Transfer', value: 'cancelSepaRecurringTransfer', action: 'Cancel a SEPA recurring transfer' },
			{ name: 'Verify SEPA Payee', value: 'verifySepaPayee', action: 'Verify a SEPA payee' },
			{ name: 'Bulk Verify SEPA Payee', value: 'bulkVerifySepaPayee', action: 'Bulk verify SEPA payees' },
			{ name: 'Skip SEPA Payee Verification', value: 'skipVerifySepaPayee', action: 'Skip SEPA payee verification' },
		],
