...
export const paymentLinksOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			{ name: 'Get Connection Status', value: 'getPaymentLinksConnectionStatus', action: 'Get payment links connection status' },
			...
			{ name: 'Deactivate Payment Link', value: 'deactivatePaymentLink', action: 'Deactivate a payment link' },
			{ name: 'List Payment Link Payments', value: 'listPaymentLinkPayments', action: 'List payments for a payment link' },
			{ name: 'List Available Payment Methods', value: 'listPaymentLinkMethods', action: 'List available payment methods' },
		],
